 ...
 * @LastEditTime: 2020-02-19 10:02:37
 */
import { connect } from 'react-redux'
import { changeRadiusType } from '../../actions'
...
const mapStateToProps = (state, ownProps) => ({
  active: ownProps.filter === ownProps.radiusType
})
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  onClick: () => {
    dispatch(changeRadiusType(ownProps.filter))
  }
})
